...
class Mysql:
	...
	def set_config(self):
		...
		self.set_db_host(config['db']['db_host']).set_username(config['db']['db_username']).set_db_password(config['db']['db_password']).set_db_prefix(config['db']['db_prefix']).set_db_name(config['db']['db_name'])
		try:
